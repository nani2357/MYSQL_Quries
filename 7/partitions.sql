...
select * from in_course

insert into in_course values('machine_learning' , 101 , 'ML', "this is ML course" ,'2019-07-07',3540,'sudhanshu',2019) ,
...
select * from in_course where course_launch_year = 2020

create table in_course1(
course_name varchar(30),
course_id int(10),
course_title varchar(30),
course_desc varchar(60),
...
select * from in_course1

insert into in_course1 values('machine_learning' , 101 , 'ML', "this is ML course" ,'2019-07-07',3540,'sudhanshu',2019) ,
...
select * from in_course1 where course_launch_year = 2020

select partition_name, table_name, table_rows from information_schema.partitions where table_name = 'in_course1'


create table in_course2(
course_name varchar(30),
course_id int(10),
course_title varchar(30),
course_desc varchar(60),
...
insert into in_course2 values('machine_learning' , 101 , 'ML', "this is ML course" ,'2019-07-07',3540,'sudhanshu',2019) ,
...
select partition_name, table_name, table_rows from information_schema.partitions where table_name = 'in_course2'
